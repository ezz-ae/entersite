...
import { developerLaunchTemplate, SiteTemplate } from '@/lib/templates';
import type { SitePage } from '@/lib/types';
import { cn } from '@/lib/utils';


export default function Home() {
  const [currentTemplate, setCurrentTemplate] = useState<SiteTemplate>(developerLaunchTemplate);
      ...
      <header className="sticky top-0 z-30 flex h-14 items-center justify-between gap-4 border-b bg-background/95 px-4 backdrop-blur-sm sm:px-6">
        ...
        <div className="flex items-center gap-3">
           <Sheet>
            ...
            <SheetContent>
              <SheetHeader>
                <SheetTitle>Site Pages</SheetTitle>
              </SheetHeader>
