      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <div className="h-[400px] bg-muted rounded-2xl overflow-hidden border relative group">
                 {/* Map Placeholder */}
                 <div className="absolute inset-0 bg-[url('https://upload.wikimedia.org/wikipedia/commons/e/ec/USA_location_map.svg')] bg-cover opacity-60 grayscale group-hover:grayscale-0 transition-all duration-500"></div>
