  ...
  return (
      <div className="min-h-screen w-screen bg-zinc-950 text-white flex flex-col items-center justify-center p-8">
          <div className="w-full max-w-2xl text-center space-y-8">
              ...
              <div className="border-2 border-dashed border-white/10 rounded-[2.5rem] p-12 bg-white/5 hover:bg-white/10 transition-all cursor-pointer group">
              ...
              <div className="pt-8 flex flex-col gap-4">
                  <Button onClick={() => onStartWithAI("Built from brochure")} className="h-16 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg w-full">
