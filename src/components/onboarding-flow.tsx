...
import { Check, ArrowRight, Building2, Map, Users, Zap, Layout, Upload, Target, Home, Key, Briefcase, Globe, X, Sparkles, SlidersHorizontal, Search, Clock, TrendingUp, Command } from "lucide-react";
...
const SITE_TYPES = [
  ...
  { id: 'roadshow', icon: <Globe className="h-4 w-4" />, label: 'Roadshow / Event' },
  { id: 'developer', icon: <Building2 className="h-4 w-4" />, label: 'Developer Showcase' },
  { id: 'partner', icon: <Users className="h-4 w-4" />, label: 'Partner Launch' },
  { id: 'company', icon: <Layout className="h-4 w-4" />, label: 'Company Website' },
];
...
const READY_TEMPLATES = [
    { id: 'template-dubai-luxury', title: "Dubai Luxury Launch", desc: "High-conversion template for premium off-plan projects.", trend: "+12% Conv." },
    { id: 'template-freelancer', title: "Agent Portfolio Minimal", desc: "Clean, personal branding for top-performing agents.", trend: "Popular" },
    { id: 'template-rak-invest', title: "RAK Investment Hub", desc: "Data-heavy layout with ROI calculators and market stats.", trend: "New" },
];
  ...
  return (
    <div className="fixed inset-0 z-50 bg-background/95 backdrop-blur-md flex items-center justify-center p-4">
      <div className="w-full max-w-5xl relative grid lg:grid-cols-[1fr_300px] gap-6">
        ...
        {/* Main Prompt Card */}
        <Card className="border-0 shadow-2xl bg-card overflow-hidden flex flex-col justify-center min-h-[600px]">
            <div className="p-8 md:p-12 space-y-10">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-lg text-muted-foreground max-w-lg mx-auto">
                        Describe your ideal real estate site, and we'll construct it instantly.
                    </p>
                </div>
                        ...
                        >
                            <Tabs defaultValue="type" className="w-full bg-muted/20 p-1 rounded-xl">
                                ...
                                <div className="p-4 bg-background mt-2 rounded-lg border shadow-sm">
                                    <TabsContent value="type" className="mt-0 grid grid-cols-2 md:grid-cols-3 gap-2">
                                        {SITE_TYPES.map(t => (
                                            <div 
                                                key={t.id} 
