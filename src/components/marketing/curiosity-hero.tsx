        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-0 px-4 pointer-events-none select-none">
            ...
            >
                ...
                <h1 className="text-5xl md:text-8xl font-bold text-white tracking-tighter max-w-5xl leading-[0.9]">
                    You've got a <span className="text-transparent bg-clip-text bg-gradient-to-br from-indigo-400 via-purple-400 to-pink-400">$100 free credit.</span> <br/>
                    Now build something real.
                </h1>
                
                <p className="text-zinc-400 text-xl md:text-2xl max-w-2xl mx-auto font-light">
                    Clear the noise. Focus on growth.
                </p>
